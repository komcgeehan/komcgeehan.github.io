...
document.addEventListener('DOMContentLoaded', (event) => {
    ...
    const ul = mappedList.querySelector('ul');
    ...
    if (bestRestaurant) {
        foundItem.innerHTML = `
            <div class="found-restaurant">
                ...
                <div>${bestRestaurant.cuisine} cuisine</div>
                <div>⭐ ${bestRestaurant.rating} rating</div>
                <div>${bestRestaurant.priceRange} · ${bestRestaurant.neighborhood}</div>
            </div>
        `;
    } else {
        foundItem.innerHTML = '<p class="placeholder">No restaurant found with that rating.</p>';
    }
