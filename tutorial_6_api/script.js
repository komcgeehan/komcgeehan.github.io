...
document.addEventListener('DOMContentLoaded', function() {
    ...
    loadButton.addEventListener('click', async function() {
        ...
        try {
            ...
            updateStatus('error', `Failed to load data: ${error.message}. Please try again.`);
            loadButton.disabled = false;
        ...
        try {
            ...
            errorDisplay.innerHTML = `
                <div class="error-message">
                    ...
                    <p>Could not load the file. It may not exist or the server is unavailable.</p>
                    <p style="font-size: 0.85rem; opacity: 0.8;">Technical detail: ${error.message}</p>
                </div>
            `;
